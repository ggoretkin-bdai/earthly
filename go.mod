...
require (
	...
	github.com/earthly/cloud-api v1.0.1-0.20230216165236-281e4a60a762
...
replace (
	...
	github.com/moby/buildkit => github.com/earthly/buildkit v0.0.1-0.20230217202933-d6934eea96a5
